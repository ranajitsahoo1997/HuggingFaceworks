...
def load_and_split_pdf(pdf_path):
    ...
    docs = splitter.split_documents(documents)[2:11]
    return docs
...
if __name__ == "__main__":
    pdf_path = "/home/ranajit/Desktop/RedIntegro/HuggingFaceWorks/Core-java-material.pdf"  # Change to your actual path
